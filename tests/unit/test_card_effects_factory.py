...
from game.card_effect_factory import get_card_effect  # or wherever the function is defined
...
def test_get_card_effect_returns_none_for_non_special():
    effect = get_card_effect("7")
    assert effect is None, "Expected None for a non-special rank like '7'"